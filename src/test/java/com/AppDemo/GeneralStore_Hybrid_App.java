...
public class GeneralStore_Hybrid_App {
	@Test
	public void hybridAppTest() throws MalformedURLException, InterruptedException {
		...
		//====set webdriver======
		//cap.setChromedriverExecutable(".\\src\\test\\resources\\chromedriver.exe");
		...
		Thread.sleep(2000);
		driver.findElement(By.name("q")).sendKeys("Amruth"+ Keys.ENTER);
